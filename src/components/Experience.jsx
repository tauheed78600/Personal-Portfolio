      ...
      <div className='flex justify-center md:flex-row flex-col md:gap-40 gap-9 mt-10 '>
        <div className='grid grid-cols-1 md:grid-cols-2 gap-9'>
          <div className='flex flex-col'>
            <div className='border p-4 rounded-xl mt-10  border-violet-500 backdrop-blur-xl hover:shadow-purple-500/50 shadow-2xl hover:scale-105 transition-transform duration-300 ease-in-out bg-transparent border border-gray-300  h-auto w-[90%] md:h-[150px] md:w-[700px]'>
            ...
            <div className='border p-4 border-violet-500 backdrop-blur-xl hover:shadow-purple-500/50 shadow-2xl rounded-xl mt-10  hover:scale-105 transition-transform duration-300 ease-in-out bg-transparent border border-gray-300 h-auto w-[90%] md:h-[150px] md:w-[700px]'>
            <div className='absolute inset-0 bg-gradient-to-br from-transparent to-purple-900 opacity-20 rounded-xl'></div>
              <div className='items-center justify-center'>
