    ...
    <div className='md:ml-[70px] ml-4 mt-20 z-0'>
      ...
      <div className='grid md:grid-cols-3 grid-cols-1 gap-6 mt-9 w-[95%]'>
        {services.map((service, index) => (
          <div key={index} className='bg-transparent border border-gray-300 backdrop-blur-xl md:w-[400px] shadow-2xl border border-purple-500 rounded-xl p-6 hover:scale-105 hover:shadow-purple-500/50 transition-transform duration-500 ease-in-out relative overflow-hidden'>
